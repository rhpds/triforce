...
export function Act00Story({ onComplete }: Props) {
  ...
  const slides = [
    ...
    <div key="spending" style={{ textAlign: 'center' }}>
      <div style={{ fontSize: 64, fontWeight: 700, fontFamily: 'monospace', color: 'var(--text-primary)', lineHeight: 1 }}>
        $684 billion
      </div>
      <div style={{ fontSize: 20, color: 'var(--text-secondary)', marginTop: 12 }}>
    ...
    <div key="failure" style={{ textAlign: 'center' }}>
      <div style={{ fontSize: 64, fontWeight: 700, fontFamily: 'monospace', color: 'var(--rh-red)', lineHeight: 1 }}>
        $547 billion
      </div>
      <div style={{ fontSize: 20, color: 'var(--rh-red)', marginTop: 12 }}>
    ...
    <div key="root" style={{ textAlign: 'center' }}>
      ...
      <div style={{ fontSize: 26, fontWeight: 600, color: 'var(--text-primary)', marginTop: 12 }}>
    ...
    <div key="cpu-idle" style={{ textAlign: 'center' }}>
      <div style={{ fontSize: 64, fontWeight: 700, fontFamily: 'monospace', color: 'var(--rh-orange)', lineHeight: 1 }}>
        12–18%
      </div>
      <div style={{ fontSize: 20, color: 'var(--text-secondary)', marginTop: 12 }}>
    ...
    <div key="reframe" style={{ textAlign: 'center' }}>
      <div style={{ fontSize: 24, fontWeight: 600, color: 'var(--rh-green)', lineHeight: 1.4 }}>
